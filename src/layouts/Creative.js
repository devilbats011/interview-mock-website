    ...
    <section className="section">
      ...
      >
        <section className="grid-span-2 lg:grid-span-1 b-check-x lg:flex lg:justify-end py-32">
          <div className="text-center width-fit mx-auto lg:mx-0 uppercase">
            <h3 className="txt2 relative b-checkx" style={{ top: "9px" }}>
              What are you waiting for?
            </h3>
            <h1 className="raleway-extra-bold size-26 size-45--md">
            ...
            <div className="relative txt1 uppercase raleway-extra-bold black my-6 flex justify-center items-center gap-1 b-checkx">
